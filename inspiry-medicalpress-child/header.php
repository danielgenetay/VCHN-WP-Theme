        ...
        <div class="container">
            <div class="row">
                ...
                if ((!empty($theme_options['header_opening_hours'])) || (!empty($theme_options['header_contact_number']))) {
                    ...
                    <!-- search -->
                    <!-- <div class="<?php bc('2', '2', '12', ''); ?>">
                      <div id="header-search">
                        <form class="header-search-form" role="search" method="get" action="<?php echo esc_url(home_url('/')); ?>">
                          <div>
                            <input type="text"  value="<?php the_search_query(); ?>" name="s" class="form-control" placeholder="<?php _e('Search', 'framework'); ?>">
        ...
        <div class="row">
            <div class="<?php bc_all('12'); ?>">
                ...
                <nav class="main-menu">
                    ...
                    <?php
                    //get_template_part('menu-search-form');
                    wp_nav_menu(array(
