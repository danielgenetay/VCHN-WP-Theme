...
if (!empty($theme_options['appointment_form_email'])) {
 ...
 <br><br><FONT COLOR="FFFFFF"><strong>&nbsp&nbspALTERNATIV 2</strong>&nbsp&nbsp&nbsp<a target="_blank" href="/wp-content/uploads/2015/11/frisvar-vuxna.pdf">Listningsblankett för Vuxna (pdf)</a>&nbsp&nbsp&nbspoch <a target="_blank" href="/wp-content/uploads/2015/11/frisvar-barn.pdf">&nbspBarn (pdf)</a>&nbsp&nbsp&nbsp Skickas med frisvar till:&nbsp&nbsp Vårdcentralen Hökarängen, 20650948, 123 20 Farsta </FONT>
