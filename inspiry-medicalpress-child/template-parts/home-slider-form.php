...
if (!empty($theme_options['appointment_form_email'])) {
 ...
 <br><br><FONT COLOR="FFFFFF"><strong>&nbsp&nbspALTERNATIV 2</strong>&nbsp&nbsp&nbsp<a href="/wp-content/uploads/2015/07/HSF-058-Vårdvalsblankett_husläkare_vuxen_ifb.pdf">Listningsblankett för Vuxna (pdf)</a>&nbsp&nbsp&nbspoch <a href="/wp-content/uploads/2015/07/HSF-058-Vårdvalsblankett_husläkare_barn_ifb.pdf">&nbspBarn (pdf)</a>&nbsp&nbsp&nbsp Skickas ofrankerat till:&nbsp&nbsp Vårdcentralen Hökarängen, Svarspost 20650948, 123 20 Farsta </FONT>
