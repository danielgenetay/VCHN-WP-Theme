...
if (!empty($theme_options['appointment_form_email'])) {
 ...
 <br><br><FONT COLOR="FFFFFF"><strong>&nbsp&nbspALTERNATIV 2</strong>&nbsp&nbsp&nbsp<a href="http://testsite.dev/wp-content/uploads/2015/06/HSF-058-Vårdvalsblankett_husläkare_vuxen_ifb.pdf">Listningsblankett för Vuxna (pdf)</a>&nbsp&nbsp&nbspoch <a href="http://testsite.dev/wp-content/uploads/2015/06/val_hlm_barn130813.pdf">&nbspBarn (pdf)</a>&nbsp&nbsp&nbsp Skickas ofrankerat till:&nbsp&nbsp Vårdcentralen Hökarängen, Svarspost 20650948, 123 20 Farsta </FONT>
